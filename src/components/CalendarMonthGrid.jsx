...
class CalendarMonthGrid extends React.PureComponent {
  ...
  componentDidUpdate() {
    const { isAnimating, transitionDuration, onMonthTransitionEnd } =
      this.props;
  ...
  render() {
    ...
    console.log("transition value:", translationValue);
    ...
    const transformType =
      isVertical || isVerticalScrollable ? "translateY" : "translateX";
          ...
          return (
            <div
              ...
              {...css(
                ...
                !isVisible &&
                  !isAnimating &&
                  styles.CalendarMonthGrid_month__hidden
              )}
            >
              <CalendarMonth
                month={month}
...
export default withStyles(
  ({ reactDates: { color, spacing, zIndex } }) => ({
    CalendarMonthGrid: {
